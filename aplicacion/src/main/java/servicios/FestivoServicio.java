...
public class FestivoServicio implements IFestivoServicio {
    ...
    public Festivo modificar(Festivo festivo) {
        if(
            repositorio.findById(festivo.getId()).isEmpty() 
        ) {return null;} else {
    ...
    //aca iria el metodo si consultan una fecha, consultar si es festivo o no validar tambien en el core, ifestivoservicio
